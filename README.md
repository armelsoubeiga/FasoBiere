...
## Download
The dataset can be downloaded from [<span style="color: red;">link to dataset</span>](https://raw.githubusercontent.com/armelsoubeiga/FasoBiere/main/Data/images%20dataset.zip).
